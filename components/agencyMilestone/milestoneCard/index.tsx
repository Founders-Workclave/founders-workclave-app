      ...
      {showConfirmModal && (
        ...
        >
          <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
            ...
            <h4 className={styles.modalTitle}>Mark milestone as completed?</h4>
            ...
            <p className={styles.modalBody}>
              ...
              as completed. This action cannot be undone and the client will be
              notified.
            </p>
            ...
            <div className={styles.modalActions}>
              ...
              <button
                ...
                disabled={isLoading}
              >
                {isLoading ? "Marking..." : "Yes, mark as completed"}
              </button>
            </div>
          </div>
        </div>
