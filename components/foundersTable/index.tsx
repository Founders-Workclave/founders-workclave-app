...
const FoundersTable: React.FC<FoundersTableProps> = ({
  ...
  const handleAction = (action: string, founderId: string) => {
    ...
    switch (action) {
      ...
      case "Reactivate":
        console.log("Reactivating founder:", founderId);
        break;
              ...
              <tr key={founder.id}>
                ...
                <td>
                  <span
                    ...
                    style={{
                      backgroundColor: `${getStatusColor(founder.status)}20`,
                  ...
                  <div className={styles.actionWrapper}>
                    ...
                    {openActionMenuId === founder.id && (
                      <div className={styles.actionMenu}>
                        <button
                          onClick={() =>
                            handleAction("See Details", founder.id)
                          }
                        >
                          See Details
                        </button>
                        ...
                        <button
                          onClick={() => handleAction("Delete", founder.id)}
              ...
              {expandedCardId === founder.id && (
                <div className={styles.mobileCardDetails}>
                  <div className={styles.detailRow}>
                    ...
                    <span className={styles.detailValue}>{founder.phone}</span>
                  </div>
                  <div className={styles.detailRow}>
                  ...
                  <div className={styles.mobileActions}>
                    <button
                      ...
                      onClick={() => handleAction("See Details", founder.id)}
                    >
                      <svg
                        width="20"
                        height="20"
