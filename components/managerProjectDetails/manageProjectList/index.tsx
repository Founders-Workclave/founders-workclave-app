...
import { TransformedManagerProject } from "@/types/managersDashbord";
import styles from "./styles.module.css";
import { ProjectRow } from "@/components/agencyProject/projectRow";
import { ProjectCard } from "@/components/agencyProject/projectCard";
import { Pagination } from "@/components/agencyProject/pagination";
import EmptyProjectIcon from "@/svgs/emptyProject";
import Loader from "@/components/loader";

interface ManagerProjectsListProps {
  initialProjects: TransformedManagerProject[];
  isLoading?: boolean;
  header: string;
}

const ManagerProjectsList: React.FC<ManagerProjectsListProps> = ({
  initialProjects,
  isLoading,
  header,
}) => {
