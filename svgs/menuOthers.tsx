...
const MenuOthers = () => {
  return (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
      ...
      />
      <path
        d="M10 4.99999C10.4602 4.99999 10.8333 4.6269 10.8333 4.16666C10.8333 3.70642 10.4602 3.33333 10 3.33333C9.53976 3.33333 9.16667 3.70642 9.16667 4.16666C9.16667 4.6269 9.53976 4.99999 10 4.99999Z"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
